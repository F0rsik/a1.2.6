...
public abstract class Minecraft implements Runnable {
	public static Block block = new Block(255,255, Material.rock);
	...
	public void startGame() throws LWJGLException {
		...
		Display.setTitle("$kid-Client 1.0.1");
		...
		if(var1 != 0 || this.field_6282_S <= 0) {
			...
			if(this.objectMouseOver == null) {
				...
				if(var1 == 0) {
					...
					if(this.block.IM){
						while(this.theWorld.getBlockId(var3,var4,var5) != 0 && this.theWorld.getBlockId(var3,var4,var5) != 7){
							this.field_6327_b.sendBlockRemoving(var3,var4,var5, this.objectMouseOver.sideHit);
						}
					}
									...
									while(true) {
										...
										if(Keyboard.getEventKey() == Keyboard.KEY_F11) {
											...
											if(this.currentScreen != null) {
												...
												if(Keyboard.getEventKey() == this.gameSettings.keyBindAKB.keyCode){
													this.thePlayer.AKB = !this.thePlayer.AKB;
												}
												if(Keyboard.getEventKey() == this.gameSettings.keyBindFB.keyCode){
													this.block.FB = !this.block.FB;
													this.field_6323_f.func_958_a();
												}
												if(Keyboard.getEventKey() == this.gameSettings.keyBindJB.keyCode){
													this.thePlayer.JB = !this.thePlayer.JB;
												}
												if(Keyboard.getEventKey() == this.gameSettings.keyBindNF.keyCode){
													this.thePlayer.NF = !this.thePlayer.NF;
												}
												if(Keyboard.getEventKey() == this.gameSettings.keyBindFly.keyCode){
													this.thePlayer.Fly = !this.thePlayer.Fly;
												}
												if(Keyboard.getEventKey() == this.gameSettings.keyBindFFly.keyCode){
													this.thePlayer.FastFly = !this.thePlayer.FastFly;
												}
												if(Keyboard.getEventKey() == this.gameSettings.keyBindXRay.keyCode){
													this.block.XRay = !this.block.XRay;
													this.field_6323_f.func_958_a();
												}
												if(Keyboard.getEventKey() == this.gameSettings.keyBindKA.keyCode){
													this.thePlayer.KA = !this.thePlayer.KA;
												}
												if(Keyboard.getEventKey() == this.gameSettings.keyBindIM.keyCode){
													this.block.IM = !this.block.IM;
												}
												if(Keyboard.getEventKey() == this.gameSettings.keyBindJesus.keyCode){
													this.block.Jesus = !this.block.Jesus;
												}
												if(Keyboard.getEventKey() == this.gameSettings.keyBindCoords.keyCode){
													this.thePlayer.Coords = !this.thePlayer.Coords;
												}
												if(Keyboard.getEventKey() == this.gameSettings.keyBindFC.keyCode){
													this.thePlayer.FC = !this.thePlayer.FC;
													if(!this.thePlayer.FC){
														this.thePlayer.Fly = false;
