...
public class EntityClientPlayerMP extends EntityPlayerSP {
	...
	public void func_4056_N() {
		...
		if(this.ridingEntity != null) {
			if(var15) {
				if(this.NF){
					this.field_797_bg.addToSendQueue(new Packet11PlayerPosition(this.motionX, -999.0D, -999.0D, this.motionZ, true));
				}
				else{
				...
				if(this.NF){
					this.field_797_bg.addToSendQueue(new Packet13PlayerLookMove(this.motionX, -999.0D, -999.0D, this.motionZ, this.rotationYaw, this.rotationPitch, true));
				}
				else{
			...
			if(this.NF){
				this.field_797_bg.addToSendQueue(new Packet13PlayerLookMove(this.posX, this.boundingBox.minY, this.posY, this.posZ, this.rotationYaw, this.rotationPitch, true));
			}
			else{
			...
			if(this.NF){
				this.field_797_bg.addToSendQueue(new Packet11PlayerPosition(this.posX, this.boundingBox.minY, this.posY, this.posZ, true));
			}
			else{
			...
			if(this.NF){
				this.field_797_bg.addToSendQueue(new Packet12PlayerLook(this.rotationYaw, this.rotationPitch, true));
			}
			else{
			...
			if(this.NF){
				this.field_797_bg.addToSendQueue(new Packet10Flying(true));
			}
			else{
