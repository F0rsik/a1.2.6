...
public class EntityPlayerSP extends EntityPlayer {
	...
	public void onLivingUpdate() {
		...
		if(this.Fly){
			...
			boolean flag = Keyboard.isKeyDown(this.mc.gameSettings.keyBindForward.keyCode);
			boolean flag1 = Keyboard.isKeyDown(this.mc.gameSettings.keyBindBack.keyCode);
			boolean flag2 = Keyboard.isKeyDown(this.mc.gameSettings.keyBindLeft.keyCode);
			boolean flag3 = Keyboard.isKeyDown(this.mc.gameSettings.keyBindRight.keyCode);
			if(flag) {
				if(flag2) {
					d -= 45.0D;
				} else if(flag3) {
			...
			} else if(Keyboard.isKeyDown(this.mc.gameSettings.keyBindSneak.keyCode)) {
				this.motionY = this.motionY - 0.2D;
			}
			if(this.FastFly){
				this.motionX *= 2.5;
