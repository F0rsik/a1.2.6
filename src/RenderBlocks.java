...
public class RenderBlocks {
	...
	public static Block block = new Block(254,255, Material.rock);
	...
	public boolean renderStandardBlock(Block var1, int var2, int var3, int var4) {
		...
		if(this.block.XRay){
			if(var1.blockID == 14 || var1.blockID == 15 || var1.blockID == 16 || var1.blockID == 56){
	...
	public boolean renderStandardBlockWithColorMultiplier(Block var1, int var2, int var3, int var4, float var5, float var6, float var7) {
		...
		float var27;
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3 - 1, var4, 0) || ((var1.blockID == 14 || var1.blockID == 15 || var1.blockID == 16 || var1.blockID == 56) && (this.block.XRay))) {
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3 + 1, var4, 1) || var1.blockID == 14 || var1.blockID == 15 || var1.blockID == 16 || var1.blockID == 56) {
			var27 = var1.getBlockBrightness(this.blockAccess, var2, var3 + 1, var4);
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 - 1, 2) || var1.blockID == 14 || var1.blockID == 15 || var1.blockID == 16 || var1.blockID == 56) {
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 + 1, 3) || var1.blockID == 14 || var1.blockID == 15 || var1.blockID == 16 || var1.blockID == 56) {
			var27 = var1.getBlockBrightness(this.blockAccess, var2, var3, var4 + 1);
			if(var1.maxZ < 1.0D) {
				var27 = var26;
			}
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 - 1, var3, var4, 4) || var1.blockID == 14 || var1.blockID == 15 || var1.blockID == 16 || var1.blockID == 56) {
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 + 1, var3, var4, 5) || var1.blockID == 14 || var1.blockID == 15 || var1.blockID == 16 || var1.blockID == 56) {
			var27 = var1.getBlockBrightness(this.blockAccess, var2 + 1, var3, var4);
			if(var1.maxX < 1.0D) {
				var27 = var26;
			}
